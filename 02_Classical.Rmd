...
This last equation will become very important in future chapoters. Notice the difference between eq.  \@ref(eq:coulomb5) for the *energy*, $E$, and eq.  \@ref(eq:coulomb3) for the *magnitude of the electric field*, $|\mathbf{E}|$. 
