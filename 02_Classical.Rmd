...
Notice the difference between this last equation for the *energy*, $E$, eq.  \@ref(eq:coulomb5) and the previous eq.  \@ref(eq:coulomb3) for the *magnitude of the electric field*, $|\mathbf{E}|$. 
