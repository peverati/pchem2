...
Tunneling can be described using the TISEq, eq. \@ref(eq:hamilt1). For the tunneling problem we can take the potential $V$ to be zero for all space, except for the region inside the barrier (between $0$ and $l$):
...
We notice that, as $l$ goes to infinity, the right hand side of eq. \@ref(eq:tunn4) goes to infinity, which does not make physical sense. To reconcile this,  we must set $D=0$. 
...
**1. In the double‑slit experiment with single particles (e.g., electrons), what is observed on the screen after many particles have passed?**

a. a single sharp peak at the center  
b. two non‑overlapping bands corresponding to the two slits  
c. a classical shadow pattern with uniform intensity between slits  
d. an interference pattern with alternating bright and dark fringes  
e. a completely uniform distribution over the screen  

---

**2. When detectors are placed at the slits to determine “which slit” each particle goes through, what typically happens to the interference pattern?**

a. it becomes sharper and more pronounced  
b. it disappears, leaving two classical‑like bands  
c. it reverses (bright and dark fringes swap)  
d. it doubles in fringe number  
e. it becomes independent of slit separation  

---

**3. In the Heisenberg uncertainty principle for position and momentum along $x$, eq. \@ref(eq:heis3), what do $\sigma_x$ and $\sigma_p$ represent?**

a. exact measurement errors of the apparatus  
b. spreads (standard deviations) in the probability distributions of $x$ and $p_x$  
c. mean values of position and momentum  
d. classical trajectory deviations  
e. arbitrary experimental tolerances chosen by the user   

---

**4. which pair of observables is *not* a standard example of canonically conjugate variables in the context of uncertainty relations?**

a. position and momentum  
b. energy and time (in a suitable sense)  
c. different components of spin  
d. particle number and phase (in some systems)  
e. mass and electric charge  

---

**5. Quantum tunneling refers to the phenomenon where a particle does what?**

a. moves faster than light through a barrier  
b. passes through a region where its classical kinetic energy would be negative  
c. reflects perfectly from any finite barrier  
d. ceases to exist inside a barrier  
e. behaves as a classical wave inside a barrier but as a particle outside  

---

**6. In a 1d potential‑barrier problem, what happens to the wave function in a classically forbidden region where $E < V(x)$?**

a. it vanishes identically  
b. it oscillates with constant amplitude  
c. it decays (or grows) exponentially with distance into the barrier  
d. it becomes a delta function at the barrier edge  
e. it becomes purely imaginary and non‑normalizable  

---

**7. For a finite barrier of width $l$, which statement about transmission probability in the tunneling example is qualitatively correct?**

a. it is exactly zero if $E < V_0$  
b. it is 1/2 regardless of barrier parameters  
c. it decreases rapidly as barrier width and/or height increase  
d. it is independent of the particle’s mass  
e. it is always 1 for normalized wave functions  

---

**8. Which of the following best explains *why* tunneling can occur even when $E < V_0$ for a barrier?**

a. energy is not conserved in quantum mechanics  
b. the wave function penetrates the classically forbidden region and has nonzero amplitude beyond it  
c. the particle temporarily borrows energy from the vacuum  
d. relativistic corrections allow the particle to accelerate  
e. the barrier momentarily disappears due to fluctuations  

---

**9. In a chemical reaction coordinate picture, what does tunneling correspond to?**

a. the reactant climbing *over* the transition-state barrier  
b. the reactant remaining in a metastable well forever  
c. the system passing *through* the barrier region where classical energy would be insufficient  
d. the system skipping the transition state entirely with zero probability  
e. the system following a purely classical minimum‑energy path  

---

**10. Which experimental signature is commonly taken as evidence for significant hydrogen tunneling in reactions?**

a. linear arrhenius plots with classical slopes  
b. very small kinetic isotope effects (k$_h$/k$_d$ $\approx$ 1 at all temperatures)  
c. large kinetic isotope effects and curved (non‑linear) arrhenius plots  
d. complete absence of isotope effects  
e. rate constants independent of temperature and isotope  
...
`r if (knitr::is_html_output()) {
  ...
  <span id="reveal-inline-content" style="display: none;">
            1.d, 2.b, 3.b, 4.e, 5.b, 6.c, 7.c, 8.b, 9.c, 10.c
  </span>
  '
