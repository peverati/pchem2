...
**1. When going from hydrogen to many‑electron atoms, which new term in the electronic hamiltonian prevents an analytic solution of the tise?**

a. electron–nuclear attraction  
b. kinetic energy  
c. electron–electron repulsion  
d. nuclear–nuclear repulsion  
e. spin–orbit coupling  

---

**2. For an n‑electron atom in non‑relativistic approximation, how does the dimensionality of the electronic configuration space scale with n?**

a. it remains 3 (independent of n)  
b. it is 3n (three spatial coordinates for each electron)  
c. it is n  
d. it is 2n (one radial and one angular coordinate per electron)  
e. it is n²  

---

**3. Which symmetry requirement must the total electronic wave function for identical electrons satisfy?**

a. symmetry under any electron exchange  
b. normalization to 1
c. invariance under global phase changes only  
d. periodicity in each coordinate  
e. antisymmetry under exchange of any two electrons (Pauli principle)

---

**4. How is antisymmetry enforced in practice in approximate many‑electron wave functions?**

a. by multiplying one‑electron functions  
b. by adding a constant term to the hamiltonian  
c. by constructing Slater determinants of spin‑orbitals  
d. by ignoring spin altogether  
e. by symmetrizing products of orbitals  


---

**5. The variational principle for an approximate normalized trial function $\Phi$ states that the energy functional $E[\Phi]$ is?**

a. always less than the exact ground‑state energy  
b. equal to the exact ground‑state energy for any trial function  
c. always greater than or equal to the exact ground‑state energy  
d. independent of the choice of trial function  
e. meaningful only for excited states  

---

**6. In the independent‑electron approximation used as a starting point for many‑electron atoms, each electron is assumed to move in?**

a. in the field of the nucleus only, ignoring other electrons  
b. in a mean or effective field generated by the nucleus and the average distribution of all other electrons  
c. in a uniform external electric field  
d. in a purely harmonic potential  
e. in free space without any potential   

---

**7. Why are hydrogen‑like orbitals still useful to build approximate many‑electron wave functions?**

a. they are exact solutions for all many‑electron atoms  
b. they form a convenient basis set to expand more realistic orbitals  
c. they automatically include electron correlation  
d. they depend only on spin variables  
e. they enforce the pauli principle without determinants  


---

**8. Which qualitative effect of electron–electron repulsion on the radial distribution of inner versus outer electrons is discussed in many‑electron treatments?**

a. outer electrons become more tightly bound than inner ones  
b. inner electrons shield outer ones, so outer electrons feel a smaller effective nuclear charge and are more diffuse  
c. shielding causes inner electrons to move further from the nucleus  
d. outer electrons experience the full nuclear charge without screening  
e. both inner and outer electrons collapse into the nucleus  

---

**9. Which of the following is *not* an effect explicitly included when one uses a simple central‑field approximation for many‑electron atoms?**

a. average electron–electron repulsion  
b. screening of nuclear charge  
c. detailed instantaneous electron–electron correlation (dynamic correlation)  
d. effective one‑electron orbital picture  
e. approximate shell structure  

---

**10. In the context of many‑electron wave functions, what is meant by “electron correlation” beyond the independent‑particle picture?**

a. changes in nuclear positions  
b. spin conservation  
c. the normalization condition  
d. the fact that exact electronic motion is correlated because electrons avoid each other more than in a mean‑field description 
e. inclusion of relativistic mass corrections  
...
`r if (knitr::is_html_output()) {
  ...
  <span id="reveal-inline-content" style="display: none;">
            1.c, 2.b, 3.e, 4.c, 5.c, 6.b, 7.b, 8.b, 9.c, 10.d
  </span>
  '
